...
func ParseTxIndexerResult(txResult *tmrpctypes.ResultTx, tx sdk.Tx, getter func(*ParsedTxs) *ParsedTx) (*humans.TxResult, error) {
...
// Due to bug https://github.com/MonCatCat/humans/issues/1175, the first `ethereum_tx` event may emit incorrect tx hash,
