...
import (
	...
	evm "github.com/MonCatCat/humans/x/evm/vm"
...
// RANDAO implementation. See https://github.com/MonCatCat/humans/pull/1520#pullrequestreview-1200504697
...
func (k *Keeper) NewEVM(
	...
	blockCtx := vm.BlockContext{
		...
		GasLimit:    humans.BlockGasLimit(ctx),
...
// GetHashFn implements vm.GetHashFunc for Humans. It handles 3 cases:
//  1. The requested height matches the current height from context (and thus same epoch number)
//  2. The requested height is from an previous height from the same chain epoch
//  3. The requested height is from a height greater than the latest one
func (k Keeper) GetHashFn(ctx sdk.Context) vm.GetHashFunc {
	return func(height uint64) common.Hash {
		h, err := humans.SafeInt64(height)
		if err != nil {
...
func (k *Keeper) ApplyMessageWithConfig(ctx sdk.Context,
	...
	// for more info https://github.com/MonCatCat/humans/issues/1085
